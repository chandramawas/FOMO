...
require_once $_SERVER['DOCUMENT_ROOT'] . "/project-sea/includes/top-bar.php";
...
if (isset($_GET['u'])) {
    ...
    //Jika data TIDAK ditemukan di database
        ...
        ?>
        <script>alert("Username tidak ditemukan"); location.href = "/project-sea/"</script>
        <?php
    }
    $stmt->close();
}
...
<body>
    <div class="main">
        <div class="page">
            <div class="header">
                <img src="/project-sea/images/profile.png" alt="Profile">
                <div class="details">
